...
const ClientCard = ({data}) => {
  return (
    <div className="clientCard d-flex justify-content-between align-items-center px-3 py-2" style={{width:"450px", height:"100px",backgroundColor:"white", borderRadius:"10px"}}>
