...
const OverViewCard = ({data}) => {
  return (
    <div className="d-flex flex-column justify-content-between align-items-center px-3 py-2" style={{width:"295px", height:"150px",backgroundColor:"white", borderRadius:"10px"}}>
