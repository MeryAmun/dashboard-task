...
const data = {
  ...
  <div className='panel-heading d-flex justify-content-between align-items-center w-100'>
    <h3 className='reportCard__title text-gray-50 p-2' style={{fontSize:"15px"}}>Finance Overview</h3>
    <div className="w-50 d-flex justify-content-between align-items-center ps-2" style={{backgroundColor:'#FFFFFF',border:"2px solid #F0F0F0"}}>
     ...
     dateFormat="yyyy"
       />
      <span style={{backgroundColor:"#EDF1F2", padding:"6px 12px"}}><IoMdSearch size={15} color="gray"/></span>
     </div>
  </div>
  ...
  <div className="d-flex flex-column justify-content-center align-items-center mx-2">
    <h5 style={{fontSize:"15px", color:"#656565",fontWeight:"400"}}>$ 0,00</h5>
    <h5 style={{fontSize:"12px", color:"#656565",fontWeight:"400",padding:"0, 8px"}}>Total Annual Income</h5>
  </div>

  <div className="d-flex flex-column justify-content-center align-items-center mx-2">
    <h5 style={{fontSize:"15px", color:"#656565",fontWeight:"400"}}>$ 0,00</h5>
    <h5 style={{fontSize:"12px", color:"#656565",fontWeight:"400",padding:"0, 8px"}}>Total Annual Expense</h5>
  </div>
  <div className="d-flex flex-column justify-content-center align-items-center mx-2">
    <h5 style={{fontSize:"15px", color:"#656565",fontWeight:"400"}}>$ 0,00</h5>
    <h5 style={{fontSize:"12px", color:"#656565",fontWeight:"400",padding:"0, 8px"}}>Total Annual Profit</h5>
  </div>
  </div>
