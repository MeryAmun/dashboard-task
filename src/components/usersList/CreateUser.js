  ...
  return (
    <div className="create__user">
      ...
      <div className="d-flex  my-1 justify-content-between align-items-center  w-50">
        ...
        <input
          type="text"
          placeholder="e.g Enter Your Language"
          name="language"
      ...
      <div className="d-flex  my-1 justify-content-between align-items-center  w-50">
        ...
        <input
          type="text"
          placeholder="e.g Enter Your mobile"
          name="mobile"
      ...
      <div className="d-flex  my-1 justify-content-between align-items-center  w-50">
        ...
        <input
          type="text"
          placeholder="e.g Enter Your Skype Id"
          name="skypeId"
      ...
      <div className="d-flex  my-1 justify-content-start align-items-center  w-50">
        <label className="photo_label">
          Profile Photo<sup style={{ color: "red" }}>*</sup>
        </label>
        <div className="d-flex flex-column justify-content-start align-items-center w-50">
          <img
            ...
            width="200px"
            className=""
            style={{ border: "2px solid  #DCE5E7", alignSelf: "flex-start" }}
          />
          <input
            type="file"
            name="profilePhoto"
      ...
      <div className="d-flex  my-1 justify-content-start align-items-start  w-50">
        <label htmlFor="permission" className="permissionInput_label">
          Permission
        </label>
        <div className="d-flex flex-column justify-content-start align-items-start w-100">
          <div className="d-flex justify-content-start align-items-center w-100">
            ...
            <div className="d-flex justify-content-start align-items-center w-100">
              <label for="everyone">
                Everyone{" "}
                <sup>
                  <FaQuestionCircle size={15} color="gray" />
                </sup>
              </label>
            </div>
          </div>
          <div className="d-flex justify-content-start align-items-center w-100">
            ...
            />
            <div className="d-flex justify-content-start align-items-center w-100">
              <label for="custom" className="w-100">
